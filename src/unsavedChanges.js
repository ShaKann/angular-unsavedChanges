...
(function (root, factory) {
  ...
  var moduleName = 'resettable';
  var mod = angular.module(moduleName, []);
  mod.value('linkLoggerOptions', {enabled: true});
  mod.directive('resettable', ['$parse', '$compile', '$rootScope',
...
(function (root, factory) {
    ...
    'use strict';
    // create your angular module and do stuff
    var moduleName = 'unsavedChanges';
    var mod = angular.module(moduleName, ['resettable']);

    mod.provider('unsavedWarningsConfig', function () {
    ...
    mod.service('unsavedWarningSharedService', ['$rootScope', 'unsavedWarningsConfig', '$injector', '$window',
    ...
    mod.directive('unsavedWarningClear', ['unsavedWarningSharedService',
    ...
    mod.directive('unsavedWarningForm', ['unsavedWarningSharedService', '$rootScope',
